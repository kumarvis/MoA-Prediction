...
class ParseExpParams:
    ...
    def get_img_dim(self):
        return int(self.img_dim) if self.img_dim.upper() != 'NONE' else -1

    def get_img_channels(self):
        return int(self.img_channels) if self.img_dim.upper() != 'NONE' else -1
...
#ob = ParseExpParams('../params.cfg')
#print(ob.get_img_dim())
